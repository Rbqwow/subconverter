...
This is a minimized image to run https://github.com/rbqwow/subconverter.

For running this docker, simply use the following commands:
```bash
# run the container detached, forward internal port 25500 to host port 25500
docker run -d --restart=always -p 25500:25500 rbqwow/subconverter:latest
...
services:
  subconverter:
    image: rbqwow/subconverter:latest
...
FROM rbqwow/subconverter:latest
